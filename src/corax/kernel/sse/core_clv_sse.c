                                 ...
                                 unsigned int        attrib)
{
  ...
  __m128d v_scale_threshold = _mm_set1_pd(CORAX_SCALE_THRESHOLD);
  __m128d v_scale_factor    = _mm_set1_pd(CORAX_SCALE_FACTOR);
                                 ...
                                 unsigned int         attrib)
{
  ...
  double *lookup =
      corax_aligned_alloc(64 * rate_cats * sizeof(double), CORAX_ALIGNMENT_SSE);
  if (!lookup)
  {
